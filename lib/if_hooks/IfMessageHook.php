...
class IfMessageHook implements IfHook {
    ...
    {
        return Hook::findBySQL("INNER JOIN message_user USING (user_id) WHERE message_user.message_id = ? AND if_type = ? AND activated = '1' ", array(is_string($object) ? $object : $object->getId(), get_class($this)));
    }
